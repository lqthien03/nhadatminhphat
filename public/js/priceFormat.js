    ...
    S.fn.priceFormat = function (x) {
        ...
        return this.each(function () {
            ...
            function g(t, r) {
                ...
                var n = function (t) {
                    ...
                    for (var r = "", n = 0; n < t.length; n++)
                        char_ = t.charAt(n),
                            ...
                            char_ && char_.match(u) && (p ? r.length < p && (r += char_) : r += char_);
                    return r
                }(t))
                    , i = ""
                    , e = 0;
                ...
                return !v || 0 == c && 0 == a || (n = -1 != t.indexOf("-") && t.indexOf("+") < t.indexOf("-") ? "-" + n : _ ? "+" + n : "" + n),
                    f && (n = f + n),
                    s && (n += s),
                    n
            }
            ...
            _ && (v = !0),
                ...
                t && (r.bind("focusout.price_format", function () {
                    a()
                }),
                    r.bind("focusin.price_format", function () {
                        r.val(f + i())
                    })),
                n && (r.bind("focusout.price_format", function () {
                    b()
                }),
                    r.bind("focusin.price_format", function () {
                        r.val(i() + s)
