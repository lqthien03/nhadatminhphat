...
<body>
                ...
                <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent text-sm" data-widget="treeview"
                    ...
                    <li class="nav-item has-treeview  ">
                        ...
                        <ul class="nav nav-treeview" style="display: block">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link active" href="/image-video/slideshow" title="Slideshow"><i
                                        class="nav-icon text-sm far fa-caret-square-right"></i>
                                    <p>Slideshow</p>
                                </a>
                            </li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="card-footer text-sm sticky-top">
                <a class="btn btn-sm bg-gradient-primary text-white" href="/image-video/slideshow/create"
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th class="align-middle" style="width:8%">Hình</th>
                        ...
                        <tbody>
                            @foreach ($slideshow as $item)
                                <tr>
                                    ...
                                    <form action="{{ route('delete.image_video.slideshow', ['id' => $item->id]) }}"
                                        method="post">
                                        @csrf
                                        @method('DELETE')
                                        <td class="align-middle text-center text-md text-nowrap">
                                            <a class="text-primary mr-2"
                                                href="/image-video/slideshow/edit/{{ $item->id }}"
    ...
    <script>
        function updateDisplayStatus(checkbox) {
            ...
            $.ajax({
                url: '/update-display-status-slideshow/' + categoryId,
                method: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
    ...
    <script>
        $('.update-stt').change(function() {
            ...
            $.ajax({
                type: 'POST',
                url: '/image-video/slideshow', // Thay đổi thành URL phù hợp với route của bạn
                data: {
                    '_token': '{{ csrf_token() }}',
                    'item_id': item_id,
