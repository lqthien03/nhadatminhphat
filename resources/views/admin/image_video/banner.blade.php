...
<body>
                ...
                <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent text-sm" data-widget="treeview"
                    ...
                    <li class="nav-item has-treeview  ">
                        ...
                        <ul class="nav nav-treeview" style="display: block">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link active" href="/image-video/banner/1" title="Banner"><i
                                        class="nav-icon text-sm far fa-caret-square-right"></i>
                                    <p>Banner</p>
                                </a>
                            </li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <form method="post" id="form-watermark" action="{{ route('edit.banner', $banner) }}"
                            ...
                            <label class="change-photo" for="file">
                                ...
                                <div class="rounded">
                                    <img class="rounded img-upload" id="uploaded-image"
                                        src="{{ asset('products/' . $banner->image) }}" alt="Alt Photo" />
                                    <strong>
