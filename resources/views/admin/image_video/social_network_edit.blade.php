...
<body>
                ...
                <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent text-sm" data-widget="treeview"
                    ...
                    <li class="nav-item has-treeview  ">
                        ...
                        <ul class="nav nav-treeview" style="display: block">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link active" href="/image-video/network-society" title="Mạng xã hội"><i
                                        class="nav-icon text-sm far fa-caret-square-right"></i>
                                    <p>Mạng xã hội</p>
                                </a>
                            </li>
    ...
    <div class="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row">
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item"><a href="/image-video/network-society" title="Mạng xã hội">Quản
                                lý
                                Mạng xã hội</a></li>
        ...
        <section class="content">
            <form method="post" action="{{ route('update.network-society', $social_network) }}"
                ...
                <div class="card-footer text-sm sticky-top">
                    ...
                    <a class="btn btn-sm bg-gradient-danger" href="/image-video/network-society" title="Thoát"><i
                            class="fas fa-sign-out-alt mr-2"></i>Thoát</a>
                </div>
                <div class="card card-primary card-outline text-sm">
                    <div class="card-header">
                        <h3 class="card-title">Chi tiết Mạng xã hội</h3>
                    </div>
                    <div class="card-body">
                            ...
                            <label class="change-photo" for="file">
                                ...
                                <div class="rounded">
                                    <img class="rounded img-upload"
                                        src="{{ asset('products/' . $social_network->image) }}" alt="Alt Photo" />
                                    <strong>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="link" id="link"
                                placeholder="Link" value="{{ old('link') ?? $social_network->link }}">
                        </div>
                        <div class="form-group">
                            ...
                            <div class="custom-control custom-checkbox d-inline-block align-middle">
                                <input type="checkbox" class="custom-control-input hienthi-checkbox" name="display"
                                    id="hienthi-checkbox"
                                    value="{{ old('display') ?? $social_network->display }}"{{ $social_network->display == 1 ? 'checked' : '' }}>
                                @if (!$social_network)
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control form-control-mini d-inline-block align-middle"
                                ...
                                value="{{ old('number') ?? $social_network->number }}">
                        </div>
                    </div>
                </div>
