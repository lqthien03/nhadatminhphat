...
<body>
                ...
                <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent text-sm" data-widget="treeview"
                    ...
                    <li class="nav-item has-treeview  ">
                        ...
                        <ul class="nav nav-treeview" style="display: block">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link active" href="/seo-page/news/1" title="Bảng báo giá"><i
                                        class="nav-icon text-sm far fa-caret-square-right"></i>
                                    <p>Tin tức</p>
                                </a>
                            </li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <form method="post" action="{{ route('update.seo_page.news', $news) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="card card-primary card-outline text-sm">
                    <div class="card-header">
                        <h3 class="card-title">Thông tin SEO page - Tin tức</h3>
                    </div>
                    <div class="card-body">
                            ...
                            <label class="change-photo" for="file">
                                ...
                                <div class="rounded">
                                    <img class="rounded img-upload" id="uploaded-image"
                                        src="{{ URL::asset('products/' . $news->image) }}" alt="Alt Photo" />
                                    <strong>
                                        ...
                                        <div class="tab-pane fade show active" id="tabs-seolang-vi" role="tabpanel"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control check-seo keywords-seo"
                                                    ...
                                                    value="{{ old('seo_ketword') ?? $news->seo->seo_keyword }}">
                                            </div>
                                            <div class="form-group">
                                                <div class="label-seo">
                                                ...
                                                <textarea class="form-control check-seo description-seo" name="seo_description" id="descriptionvi" rows="5"
                                                    placeholder="SEO Description (vi)">{{ old('seo_keyword') ?? $news->seo->seo_keyword }}</textarea>
                                            </div>
