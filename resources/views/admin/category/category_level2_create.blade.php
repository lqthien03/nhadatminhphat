            ...
            <div class="container-fluid">
                <div class="row">
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item active">Chi tiết Sản phẩm cấp 2</li>
                    </ol>
                </div>
            </div>
        </section>
        ...
        <section class="content">
            <form class="validation-form" novalidate method="post" action="{{ route('store.category2') }}"
                ...
                <div class="card-footer text-sm sticky-top">
                    ...
                    <a class="btn btn-sm bg-gradient-danger" href="/category-level-2" title="Thoát"><i
                ...
                <div class="row">
                    <div class="col-xl-8">
                        ...
                        <div class="card card-primary card-outline text-sm">
                            <div class="card-header">
                                <h3 class="card-title">Nội dung Sản phẩm cấp 2</h3>
                            ...
                            <div class="card-body">
                                <div class="form-group-category">
                                    <select id="id_list" name="level1_product_id" data-level="0"
                                        ...
                                        class="form-control select2 select-category @error('level1_product_id') is-invalid @enderror">
                                            ...
                                            <div
                                                ...
                                                <div class="seo-preview">
                                                    <p class="slug-seo-preview" id="seourlpreviewvi"
                                                        data-seourlstatic="1">https://phatnang.com/<strong></strong>
                                                    </p>
