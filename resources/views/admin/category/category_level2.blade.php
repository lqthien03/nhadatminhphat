...
<body>
                ...
                <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent text-sm" data-widget="treeview"
                    ...
                    <li class="nav-item has-treeview  ">
                        ...
                        <ul class="nav nav-treeview" style="display: block">
                            ...
                            <li class="nav-item "><a class="nav-link active" href="/category-level-2"
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="card-footer text-sm sticky-top">
                <a class="btn btn-sm bg-gradient-primary text-white" href="/category-level-2/create"
            ...
            <div class="card-footer form-group-category text-sm bg-light row">
                <div class="form-group col-xl-2 col-lg-3 col-md-4 col-sm-4 mb-2">
                    <select id="id_list" name="level1_product_id" class="form-control filer-category select2">
            ...
            <div class="card card-primary card-outline text-sm mb-0">
                <div class="card-header">
                    <h3 class="card-title">Danh sách Sản phẩm cấp 2</h3>
                </div>
    ...
    <!-- Thêm đoạn mã JavaScript sau cùng của trang của bạn -->
    <script>
    ...
    <script>
        $('.update-stt').change(function() {
            ...
            $.ajax({
                type: 'POST',
                url: '/category-level-2', // Thay đổi thành URL phù hợp với route của bạn
                data: {
                    '_token': '{{ csrf_token() }}',
                    'item_id': item_id,
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('id_list').addEventListener('change', function() {
                ...
                window.location.href = "{{ route('show.category2') }}?level1_product_id=" +
                    selectedCategoryId;
            });
        });
    </script>
