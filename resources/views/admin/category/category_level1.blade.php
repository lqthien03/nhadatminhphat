            ...
            <nav class="mt-3">
                <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent text-sm" data-widget="treeview"
                    ...
                    <li class="nav-item active">
                        <a class="nav-link " href="/dashboard" title="Bảng điều khiển">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="card-footer text-sm sticky-top">
                <a class="btn btn-sm bg-gradient-primary text-white" href="/category-level-1/create"
                        ...
                        <tbody>
                            @foreach ($category_level1 as $item)
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <a href="/category-level-1/edit/{{ $item->id }}"
                                            title="{{ $item->tittle }}"><img class="rounded img-preview"
                                                src="{{ URL::asset('products/' . $item->image) }}"
                                                alt="{{ $item->tittle }}"></a>
                                    </td>
                                    <td class="align-middle">
                                        <a class="text-dark" href="/category-level-1/edit/{{ $item->id }}"
                                    ...
                                    <form action="{{ route('delete.category1', ['id' => $item->id]) }}"
                                        ...
                                        <td class="align-middle text-center text-md text-nowrap">
                                            <a class="text-primary mr-2"
                                                href="/category-level-1/edit/{{ $item->id }}" title=""><i
