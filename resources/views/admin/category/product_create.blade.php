...
<body>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <form class="validation-form" novalidate method="post" action="{{ route('store.product') }}"
                ...
                <div class="card card-primary card-outline text-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                <label class="d-block" for="giamoi">Địa chỉ:</label>
                                <div class="input-group">
                                    <input type="text" class="form-control format-price gia_moi" name="address"
                                        id="giamoi" placeholder="Địa chỉ" value="">
                                    {{-- <div class="input-group-append">
                                        <div class="input-group-text"><strong>VNĐ</strong></div>
                                    </div> --}}
                                </div>
                            ...
                            <div class="form-group col-md-4">
                                <label class="d-block" for="giakm">Kích thước:</label>
                                <div class="input-group">
                                    <input type="text" class="form-control gia_km" name="size" id="giakm"
                                        placeholder="Kích thước" value="" maxlength="10">
                            ...
                            <div class="form-group col-md-4">
                                <label class="d-block" for="giakm">Diện tích:</label>
                                <div class="input-group">
                                    <input type="text" class="form-control gia_km" name="acreage" id="giakm"
                                        placeholder="Diện tích" value="" maxlength="10">
                            ...
                            <div class="form-group col-md-4">
                                <label class="d-block" for="giakm">Liên hệ:</label>
                                <div class="input-group">
                                    <input type="text" class="form-control gia_km" name="contact" id="giakm"
                                        placeholder="Liên hệ" value="" maxlength="10">
                                    <div class="input-group-append">
                            ...
                            <div class="form-group col-md-4">
                                <label class="d-block" for="giakm">Hướng:</label>
                                <div class="input-group">
                                    <input type="text" class="form-control gia_km" name="direction"
                                        id="giakm" placeholder="Hướng" value="">
                            ...
                            <div class="form-group col-md-4">
                                <label class="d-block" for="giakm">Vị trí:</label>
                                <div class="input-group">
                                    <input type="text" class="form-control gia_km" name="location" id="giakm"
                                        placeholder="Vị trí" value="">
                            ...
                            <div class="jFiler-input-dragDrop">
                                <div class="jFiler-input-inner">
                                    ...
                                    <div class="jFiler-input-text">
                                        <h3 onclick="document.getElementById('filer-gallery').click();">Kéo và thả hình
                                            vào đây</h3> <!-- Kích hoạt sự kiện click cho input file -->
    ...
    {{-- <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function generateSEO() {
                ...
                // Lấy giá trị từ tab Tiếng Việt
                var tabLangVi = document.getElementById('tabs-lang-vi');
                var titleViInTab = tabLangVi.querySelector('#tenvi').value;

                // Gán giá trị vào form SEO
                document.getElementById('titlevi').value = titleViInTab;
                document.getElementById('keywordsvi').value = titleViInTab;
                document.getElementById('descriptionvi').value = titleVi;
