                                ...
                                <div class="photoUpload-zone" id="photoUploadZone">
                                    <div class="photoUpload-detail" id="photoUpload-preview">
                                        <img class="rounded" id="uploaded-image"
                                            src="{{ asset('products/default_image.jpg') }}" alt="Alt Photo" />
                                    </div>
