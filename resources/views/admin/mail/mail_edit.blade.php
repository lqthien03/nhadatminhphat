...
<body>
                ...
                <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent text-sm" data-widget="treeview"
                    ...
                    <li class="nav-item has-treeview  ">
                        ...
                        <ul class="nav nav-treeview" style="display: block">
                            <li class="nav-item ">
                                <a class="nav-link active" href="/receive-news/contact-letter"
    ...
    <div class="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row">
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item"><a href="/receive-news/contact-letter"
                                title="Quản lý Thư liên hệ">Quản lý Thư
                                liên hệ</a></li>
        ...
        <section class="content">
            <form method="post" action="{{ route('update.mail.contact', $mail) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card-footer text-sm sticky-top">
                    ...
                    <a class="btn btn-sm bg-gradient-danger" href="/receive-news/contact-letter" title="Thoát"><i
                            class="fas fa-sign-out-alt mr-2"></i>Thoát</a>
                </div>
                <div class="card card-primary card-outline text-sm">
                    <div class="card-header">
                        <h3 class="card-title">Chi tiết Thư liên hệ</h3>
                    </div>
                    <div class="card-body">
                        <div class="form-group-category row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" name="name" id="ten"
                                    placeholder="Họ tên" value="{{ old('name') ?? $mail->name }}">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="dienthoai">Điện thoại:</label>
                                <input type="text" class="form-control" name="phone" id="dienthoai"
                                    placeholder="Điện thoại" value="{{ old('phone') ?? $mail->phone }}">

                            </div>
                            <div class="form-group col-md-4">
                                <label for="email">Email:</label>
                                <input type="email" class="form-control" name="email" id="email"
                                    placeholder="Email" value="{{ old('email') ?? $mail->email }}">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="chude" class="form-control" name="topic" id="chude"
                                    placeholder="Chủ đề" value="{{ old('topic') ?? $mail->topic }}">

                            </div>
                            <div class="form-group col-md-4">
                                <label for="diachi">Địa chỉ:</label>
                                <input type="text" class="form-control" name="address" id="diachi"
                                    placeholder="Địa chỉ" value="{{ old('address') ?? $mail->address }}">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select id="tinhtrang" name="status" class="form-control select2">
                                    <option value="0" @if ($mail->status == 0) selected @endif>Chưa xem
                                    </option>
                                    <option value="1" @if ($mail->status == 1) selected @endif>Đã xem
                                    </option>
                                    <option value="2" @if ($mail->status == 2) selected @endif>Đã liên hệ
                                    </option>
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="content" id="noidung" rows="5" placeholder="Nội dung">{{ old('content') ?? $mail->content }}</textarea>

                        </div>
                        <div class="form-group">
                            <label for="ghichu">Ghi chú:</label>
                            <textarea class="form-control" name="note" id="ghichu" rows="5" placeholder="Ghi chú">{{ old('note') ?? $mail->note }}</textarea>
