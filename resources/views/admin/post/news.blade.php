...
<body>
                ...
                <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent text-sm" data-widget="treeview"
                    ...
                    <li class="nav-item has-treeview  ">
                        ...
                        <ul class="nav nav-treeview" style="display: block">
                            <li class="nav-item"><a class="nav-link active" href="/post/news"
                                ...
                                <tr>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul aria-labelledby="dropdownCopy"
                                                    ...
                                                    <li><a href="#" class="dropdown-item copy-now"
                                                            ...
                                                            chép ngay</a></li>
                                                    <li><a href="/post/news/edit/{{ $item->id }}"
                                    ...
                                    <td class="align-middle text-center">
                                        <div class="custom-control custom-checkbox my-checkbox">
                                            <input type="checkbox" class="custom-control-input show-checkbox"
                                                ...
                                                onchange="updateDisplayStatus6(this)">
                                    ...
                                    <form action="{{ route('delete.news', ['id' => $item->id]) }}" method="post">
                                        ...
                                        <td class="align-middle text-center text-md text-nowrap">
                                            ...
                                            <a class="text-primary mr-2" href="/post/news/edit/{{ $item->id }}"
    ...
    <script>
        function updateDisplayOutstand(checkbox) {
            ...
            // Gửi yêu cầu Ajax để cập nhật trạng thái vào cơ sở dữ liệu
            $.ajax({
                url: '/update-display-outstand-news/' + categoryId,
                method: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
    ...
    <script>
        $('.update-stt').change(function() {
            ...
            $.ajax({
                type: 'POST',
                url: '/post/news', // Thay đổi thành URL phù hợp với route của bạn
                data: {
                    '_token': '{{ csrf_token() }}',
                    'item_id': item_id,
