...
<body>
    ...
    <div class="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row">
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item active">Danh sách tư vấn</li>
                    </ol>
                </div>
            </div>
        </section>
        ...
        <section class="content">
            <div class="card-footer text-sm sticky-top">
                <a class="btn btn-sm bg-gradient-primary text-white" href="/post/advise/create" title="Thêm mới"><i
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        ...
                                        <div class="tool-action mt-2 w-clear">
                                            ...
                                            <a class="text-info mr-3" href="/post/advise/edit/{{ $item->id }}"
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul aria-labelledby="dropdownCopy"
                                                    ...
                                                    <li><a href="#" class="dropdown-item copy-now"
                                                            ...
                                                            chép ngay</a></li>
                                                    <li><a href="/post/advise/edit/{{ $item->id }}"
                                    ...
                                    <form action="{{ route('delete.news', ['id' => $item->id]) }}" method="post">
                                        ...
                                        <td class="align-middle text-center text-md text-nowrap">
                                            ...
                                            <a class="text-primary mr-2" href="/post/advise/edit/{{ $item->id }}"
    ...
    <script>
        function updateDisplayStatus(checkbox) {
            ...
            $.ajax({
                url: '/update-display-status-advise/' + categoryId,
                method: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
    ...
    <script>
        $('.update-stt').change(function() {
            ...
            $.ajax({
                type: 'POST',
                url: '/post/advise', // Thay đổi thành URL phù hợp với route của bạn
                data: {
                    '_token': '{{ csrf_token() }}',
                    'item_id': item_id,
