    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <form class="validation-form" novalidate method="post"
                action="{{ route('update.real_estate', $real_estate) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <input type="hidden" name="seo_id" value="{{ $real_estate->seo_id }}">
                ...
                <div class="card-footer text-sm sticky-top">
                    ...
                    <a class="btn btn-sm bg-gradient-danger" href="/post/real-estate" title="Thoát"><i
                                            ...
                                            <div class="tab-pane fade show active" id="tabs-sluglang-vi"
                                                ...
                                                <div class="form-gourp mb-0">
                                                    ...
                                                    <input type="text" class="form-control slug-input no-validate"
                                                        ...
                                                        value="{{ old('link') ?? $real_estate->link }}">
                                            ...
                                            <div class="tab-pane fade show active" id="tabs-lang-vi" role="tabpanel"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control for-seo" name="tittle"
                                                        ...
                                                        value="{{ old('tittle') ?? $real_estate->tittle }}" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="motavi">Mô tả (vi):</label>
                                                    <textarea class="form-control for-seo " name="describe" id="motavi" rows="5" placeholder="Mô tả (vi)">{{ old('describe') ?? $real_estate->describe }}</textarea>
                            ...
                            <div class="card-body">
                                <div class="photoUpload-zone" id="photoUploadZone">
                                    <div class="photoUpload-detail" id="photoUpload-preview"><img class="rounded"
                                            id="uploaded-image" src="{{ asset('products/' . $real_estate->image) }}"
                                            alt="Alt Photo" /></div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-control custom-checkbox d-inline-block align-middle">
                                <input type="checkbox" class="custom-control-input hienthi-checkbox" name="display"
                                    id="hienthi-checkbox"
                                    value="{{ old('display') ?? $real_estate->display }}"{{ $real_estate->display == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control form-control-mini d-inline-block align-middle"
                                ...
                                value="{{ old('number') ?? $real_estate->number }}">
                        </div>
                    </div>
                </div>
                <div class="card card-primary card-outline text-sm">
                                        ...
                                        <div class="tab-pane fade show active" id="tabs-seolang-vi" role="tabpanel"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control check-seo title-seo"
                                                    ...
                                                    value="{{ old('seo_tittle') ?? $real_estate->seo->seo_tittle }}">
                                            </div>
                                            <div class="form-group">
                                                <div class="label-seo">
                                                ...
                                                <input type="text" class="form-control check-seo keywords-seo"
                                                    ...
                                                    value="{{ old('seo_keyword') ?? $real_estate->seo->seo_keyword }}">
                                            </div>
                                            <div class="form-group">
                                                <div class="label-seo">
                                                ...
                                                <textarea class="form-control check-seo description-seo" name="seo_description" id="descriptionvi" rows="5"
                                                    placeholder="SEO Description (vi)">{{ old('seo_description') ?? $real_estate->seo->seo_description }}</textarea>
                                            </div>
