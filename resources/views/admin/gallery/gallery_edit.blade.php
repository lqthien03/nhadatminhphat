...
<body>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <form method="post" action="{{ route('edit.gallery', $gallery) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="card-footer text-sm sticky-top">
                    ...
                    <a class="btn btn-sm bg-gradient-danger" href="/product/gallery/{{ $gallery->product_id }}"
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label class="change-photo" for="file">
                                <p>Upload hình ảnh:</p>
                                <div class="rounded">
                                    <img class="rounded img-upload" src="{{ asset('products/' . $gallery->image) }}"
                                        alt="Alt Photo" />
                                    <strong>
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-control custom-checkbox d-inline-block align-middle">
                                <input type="checkbox" class="custom-control-input hienthi-checkbox"
                                    ...
                                    value="{{ old('display') ?? $gallery->display }}"
                                    {{ $gallery->display == 1 ? 'checked' : '' }}>
