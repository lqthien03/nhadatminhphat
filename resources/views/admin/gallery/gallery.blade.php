        ...
        <section class="content">
            <div class="card-footer text-sm sticky-top">
                <a class="btn btn-sm bg-gradient-primary text-white"
                    href="/product/gallery/create/{{ $gallery->first()->product_id }}" title="Thêm mới"><i
                ...
                <a class="btn btn-sm bg-gradient-secondary" href="/product" title="Thoát"><i
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <input type="number" class="form-control form-control-mini m-auto update-stt"
                                            min="0" value="{{ $item->id }}"
                                            data-id="{{ $item->id }}" data-table="gallery">
                                    </td>
                                    <td class="align-middle text-center">
                                        <a href="/product/gallery/edit/{{ $item->id }}"
                                    ...
                                    <td class="align-middle text-center">
                                        <div class="custom-control custom-checkbox my-checkbox">
                                            <input type="checkbox" class="custom-control-input show-checkbox"
                                                id="show-checkbox-1602" data-table="gallery"
                                                data-id="{{ $item->id }}" data-loai="hienthi"
                                                {{ $item->display == 1 ? 'checked' : '' }}>
                                            <label for="show-checkbox-1602" class="custom-control-label"></label>
                                        </div>
                                    </td>
                                    <form action="{{ route('delete.gallery', ['id' => $item->id]) }}" method="post">
                                        @csrf
                                        @method('DELETE')
                                        <td class="align-middle text-center text-md text-nowrap">
                                            <a class="text-primary mr-2"
                                                href="/product/gallery/edit/{{ $item->id }}" title="Chỉnh sửa"><i
