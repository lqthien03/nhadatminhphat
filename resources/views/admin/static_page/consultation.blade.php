                ...
                <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent text-sm" data-widget="treeview"
                    ...
                    <li class="nav-item has-treeview  ">
                        ...
                        <ul class="nav nav-treeview" style="display: block">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link active" href="/static-page/register-consultation/1"
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <form class="validation-form" novalidate method="post"
                action="{{ route('update.register_consultation', $consultation) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-checkbox d-inline-block align-middle">
                                        <input type="checkbox" class="custom-control-input hienthi-checkbox"
                                            ...
                                            value="{{ old('display') ?? $consultation->display }}"{{ $consultation->display == 1 ? 'checked' : '' }}>
                                        @if (!$consultation)
                                            ...
                                            <div class="tab-pane fade show active" id="tabs-lang-vi" role="tabpanel"
                                                ...
                                                {{-- <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control for-seo" name="tittle"
                                                        ...
                                                        value="{{ old('tittle') ?? $consultation->tittle }}" required>
                                                </div> --}}
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control for-seo form-control-ckeditor" name="content" id="noidungvi" rows="5"
                                                        placeholder="Nội dung (vi)">{{ old('content') ?? $consultation->content }}</textarea>
                                                </div>
                                                <script>
