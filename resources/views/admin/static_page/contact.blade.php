...
<body>
                ...
                <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent text-sm" data-widget="treeview"
                    ...
                    <li class="nav-item has-treeview  ">
                        ...
                        <ul class="nav nav-treeview" style="display: block">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link active" href="/static-page/contact/1" title="Liên hệ"><i
                                        class="nav-icon text-sm far fa-caret-square-right"></i>
                                    <p>Liên hệ</p>
                                </a>
                            </li>
            ...
            <form class="validation-form" novalidate method="post" action="{{ route('update.contact', $contact) }}"
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4">
                        <div class="card card-primary card-outline text-sm">
                            <div class="card-header">
                                <h3 class="card-title">Hình ảnh Liên hệ</h3>
                                <div class="card-tools">
                                    <button type="button" class="btn btn-tool" data-card-widget="collapse"><i
                                            class="fas fa-minus"></i></button>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="photoUpload-zone">
                                    <div class="photoUpload-detail" id="photoUpload-preview"><img class="rounded"
                                            id="uploaded-image" src="{{ asset('products/' . $contact->image) }}"
                                            alt="Alt Photo" /></div>
                                        ...
                                        <div class="tab-pane fade show active" id="tabs-seolang-vi" role="tabpanel"
                                            ...
                                            <div class="form-group ">
                                                <div class="label-seo">
                                                    ...
                                                    <strong class="count-seo-tittle"><span>26</span>/70 ký tự</strong>
                                                </div>
                                            ...
                                            <div class="form-group ">
                                                <div class="label-seo">
                                                    ...
                                                    <strong class="count-seo-keywords"><span>0</span>/70 ký
                                                        tự</strong>
                                                </div>
                                            ...
                                            <div
                                                ...
                                                <div class="seo-preview">
                                                    ...
                                                    <p class="title-seo-preview text-split" id="title-seo-previewvi">
                                                        Liên Hệ VI TÍNH PHÁT NĂNG</p>
                                                    <p class="description-seo-preview text-split"
                                                        id="description-seo-previewvi">
                                                        {{ old('seo_description') ?? $contact->seo->seo_description }}
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script>
        // Sử dụng JavaScript để tính số kí tự và hiển thị nó
        document.addEventListener('DOMContentLoaded', function() {
            var seoTitleInput = document.getElementById('titlevi');
            var seoTitleCount = document.getElementById('seoTitleCount');

            // Gắn sự kiện người dùng nhập liệu
            seoTitleInput.addEventListener('input', function() {
                var currentCount = seoTitleInput.value.length;
                seoTitleCount.textContent = currentCount + '/70 ký tự';
            });
        });
    </script>
    <script>
