...
<head>
    ...
    <title>NHÀ ĐẤT MINH PHÁT</title>
    <meta name="keywords"
        content="nhà đất minh phát chuyên bán nhà phố, bán đất nền, mua bán đất giá rẻ, mua bán nhà phố, mua bán nhà phố hcm, bán nhà hcm, bán nhà phố giá rẻ, mua bán đất hcm, mua bán đất, ký gửi nhà đất, hoàn công,  tư vấn pháp lý." />
    ...
    <meta name="author" content="NHÀ ĐẤT MINH PHÁT" />
    <meta name="copyright" content="NHÀ ĐẤT MINH PHÁT - [tranquangthu986@gmail.com]" />
    <!-- Facebook -->
    <meta property="og:type" content="object" />
    <meta property="og:site_name" content="NHÀ ĐẤT MINH PHÁT" />
    <meta property="og:title" content="NHÀ ĐẤT MINH PHÁT" />
    <meta property="og:description"
        content="Nhà đất minh phát chuyên bán nhà phố, bán đất nền, mua bán đất giá rẻ, mua bán nhà phố, mua bán nhà phố hcm, bán nhà hcm, bán nhà phố giá rẻ, mua bán đất hcm, mua bán đất, ký gửi nhà đất, hoàn công,  tư vấn pháp lý." />
    <meta property="og:url" content="https://nhadatminhphat.com.vn/san-pham" />
    <meta property="og:image"
        content="https://nhadatminhphat.com.vn/thumbs/100x100x2/upload/seopage/logo-5206-4320.png" />
    <meta property="og:image:alt" content="NHÀ ĐẤT MINH PHÁT" />
    <meta property="og:image:type" content="image/png" />
    <meta property="og:image:width" content="100" />
    <meta property="og:image:height" content="100" />
    <!-- Twitter -->
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:site" content="tranquangthu986@gmail.com" />
    <meta name="twitter:creator" content="NHÀ ĐẤT MINH PHÁT" />
    <meta property="og:url" content="https://nhadatminhphat.com.vn/san-pham" />
    <meta property="og:title" content="NHÀ ĐẤT MINH PHÁT" />
    <meta property="og:description"
        content="Nhà đất minh phát chuyên bán nhà phố, bán đất nền, mua bán đất giá rẻ, mua bán nhà phố, mua bán nhà phố hcm, bán nhà hcm, bán nhà phố giá rẻ, mua bán đất hcm, mua bán đất, ký gửi nhà đất, hoàn công,  tư vấn pháp lý." />
    <meta property="og:image"
        content="https://nhadatminhphat.com.vn/thumbs/100x100x2/upload/seopage/logo-5206-4320.png" />
    <!-- Canonical -->
    <link rel="canonical" href="https://nhadatminhphat.com.vn/san-pham" />
...
<body>
    <div class="wapper">
        ...
        <h1 class="hidden-seoh">Nhà đất</h1>
                        ...
                        <ul>
                            @foreach ($level1products as $item)
                                <li>
                                    ...
                                    <ul>
                                        {{-- @if ($item->Level1Childrent->count())
                                            @foreach ($m as $item)
                                                <li><a href="/{{ $item->link }}">{{ $item->tittle }}</a></li>
                                            @endforeach
                                        @endif --}}
                                    </ul>
                                </li>
            ...
            <div class="main_fix">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a class="text-decoration-none" href="/"><span>Trang
                                chủ</span></a></li>
                    <li class="breadcrumb-item active"><a class="text-decoration-none" href="/san-pham"><span>Nhà
                                đất</span></a></li>
                </ol>
                <script type="application/ld+json">{"@context": "https://schema.org","@type": "BreadcrumbList","itemListElement": [{"@type":"ListItem","position":1,"name":"Nh\u00e0 \u0111\u1ea5t","item":"https:\/\/nhadatminhphat.com.vn\/san-pham"}]}</script>
            </div>
        </div>
        <div class="main_content main_fix clear">
            <div class="title-main"><span>{{ $products_level1->first()->tittle }}</span></div>
            <div class="wap_item">
                @foreach ($detail as $item)
                    <div class="item">
                        <span class="moi"></span>
                        <p class="img_sp zoom_hinh"><a href="/san-pham/{{ $item->link }}"
                                title="{{ $item->tittle }}"><img src="{{ URL::asset('products/' . $item->image) }}"
                                    alt="{{ $item->tittle }}"></a>
                        </p>
