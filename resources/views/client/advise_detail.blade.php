...
<head>
    ...
    <meta property="og:url" content="{{ $setting->website }}/tu-van/{{ $advise->link }}" />
    ...
    <meta property="og:image" content="{{ asset('products/' . $logo->first()->image) }}" />
    <!-- Canonical -->
    <link rel="canonical" href="{{ $setting->website }}/tu-van/{{ $advise->link }}" />
...
<body>
    <div class="wapper">
            ...
            <div class="main_fix">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a class="text-decoration-none" href="/"><span>Trang
                                chủ</span></a></li>
                    <li class="breadcrumb-item "><a class="text-decoration-none" href="/tu-van"><span>Tư
                                vấn</span></a></li>
                    <li class="breadcrumb-item active"><a class="text-decoration-none"
                            href="/tu-van/{{ $advise->link }}"><span>{{ $advise->tittle }}</span></a></li>
                </ol>
        ...
        <div class="main_content main_fix clear">
            <div class="w_1000">
                <div class="title-main"><span>{{ $advise->tittle }}</span></div>
