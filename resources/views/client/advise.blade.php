...
<head>
    ...
    <meta property="og:url" content="{{ $setting->website }}/tu-van" />
    ...
    <meta property="og:image" content="{{ asset('products/' . $logo->first()->image) }}" />
    <!-- Canonical -->
    <link rel="canonical" href="{{ $setting->website }}/tu-van" />
...
<body>
    <div class="wapper">
        ...
        <h1 class="hidden-seoh">Tư vấn</h1>
        ...
        <div class="wap_menu clear hidden_m">
            <div class="menu main_fix">
                <ul>
                    ...
                    <li><a class="active" href="/tu-van" title="Tư vấn">Tư vấn</a></li>
            ...
            <div class="main_fix">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a class="text-decoration-none" href="/"><span>Trang
                                chủ</span></a></li>
                    <li class="breadcrumb-item active"><a class="text-decoration-none" href="/tu-van"><span>Tư
                                vấn</span></a></li>
                </ol>
                <script type="application/ld+json">{"@context": "https://schema.org","@type": "BreadcrumbList","itemListElement": [{"@type":"ListItem","position":1,"name":"T\u01b0 v\u1ea5n","item":"https:\/\/nhadatminhphat.com.vn\/tu-van"}]}</script>
            </div>
        </div>
        <div class="main_content main_fix clear">
            <div class="title-main"><span>Tư vấn</span></div>
            <div class="wap_news">
                @foreach ($advise as $item)
                    @if ($item->display == 1)
                        <div class="item_news">
                            <p class="img_post zoom_hinh"><a href="/tu-van/{{ $item->link }}"><img
                                        src="{{ URL::asset('products/' . $item->image) }}" alt="{{ $item->tittle }}"
                                        width="381px" height="238px"></a>
                            </p>
                            <div class="mota">
                                <h3><a class="name_post catchuoi2"
                                        href="/tu-van/{{ $item->link }}">{{ $item->tittle }}</a></h3>
