...
<head>
    ...
    <meta property="og:url" content="{{ $setting->website }}/gioi-thieu" />
    <meta property="og:title" content="{{ $seo->first()->seo_tittle }}" />
    <meta property="og:description" content="{{ $seo->first()->seo_description }}" />
    <meta property="og:image" content="{{ asset('products/' . $logo->first()->image) }}" />
    <!-- Canonical -->
    <link rel="canonical" href="{{ $setting->website }}/gioi-thieu" />
        ...
        <div class="wap_menu clear hidden_m">
            <div class="menu main_fix">
                <ul>
                    ...
                    <li><a class="active" href="/gioi-thieu" title="Giới thiệu">Giới thiệu</a></li>
            ...
            <div class="main_fix">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a class="text-decoration-none" href="/"><span>Trang
                                chủ</span></a></li>
                    <li class="breadcrumb-item active"><a class="text-decoration-none" href="/gioi-thieu"><span>Giới
                                thiệu</span></a></li>
                </ol>
                <script type="application/ld+json">{"@context": "https://schema.org","@type": "BreadcrumbList","itemListElement": [{"@type":"ListItem","position":1,"name":"Gi\u1edbi thi\u1ec7u","item":"https:\/\/nhadatminhphat.com.vn\/gioi-thieu"}]}</script>
            </div>
        </div>
        <div class="main_content main_fix clear">
            <div class="w_1000">
                ...
                <div class="a2a_kit a2a_kit_size_32 a2a_default_style share" style="height:50px;"
                    data-a2a-title="Share"><a class="a2a_dd" href="https://nhadatminhphat.com.vn/gioi-thieu"></a><a
                        class="a2a_button_facebook"></a><a class="a2a_button_twitter"></a><a
                        class="a2a_button_facebook_messenger"></a>
                    <div class="zalo-share-button" data-href="https://nhadatminhphat.com.vn/gioi-thieu"
