...
<head>
    ...
    <meta property="og:url" content="{{ $setting->website }}/thu-tuc-nha-dat" />
    ...
    <meta property="og:image" content="{{ asset('products/' . $logo->first()->image) }}" />
    <!-- Canonical -->
    <link rel="canonical" href="{{ $setting->website }}/thu-tuc-nha-dat" />
...
<body>
    <div class="wapper">
        ...
        <h1 class="hidden-seoh">Thủ tục nhà đất</h1>
            ...
            <div class="main_fix">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a class="text-decoration-none"
                            href="/thu-tuc-nha-dat"><span>Thủ tục nhà đất</span></a></li>
                </ol>
                <script type="application/ld+json">{"@context": "https://schema.org","@type": "BreadcrumbList","itemListElement": [{"@type":"ListItem","position":1,"name":"Th\u1ee7 t\u1ee5c nh\u00e0 \u0111\u1ea5t","item":"https:\/\/nhadatminhphat.com.vn\/thu-tuc-nha-dat"}]}</script>
            </div>
        </div>
                    ...
                    @if ($item->display == 1)
                        <div class="item_news">
                            <p class="img_post zoom_hinh"><a href="thu-tuc-nha-dat/{{ $item->link }}"><img
                                        src="{{ URL::asset('products/' . $item->image) }}" alt="Hoàn công"></a></p>
                            <div class="mota">
                                <h3><a class="name_post catchuoi2" href="hoan-cong">{{ $item->tittle }}</a></h3>
